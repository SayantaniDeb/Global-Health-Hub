                      ...
                      <div className="max-w-sm rounded overflow-hidden shadow-lg">
                        ...
                        <div className="px-6 py-4">
                          ...
                          <p className="text-gray-700 text-base">
                            ...
                            elit. Duis imperdiet urna sit amet sapien suscipit,
                            vel fermentum purus maximus.
                          </p>
                        </div>
                      </div>
                      <div className="max-w-sm rounded overflow-hidden shadow-lg">
